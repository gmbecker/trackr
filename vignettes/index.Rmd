...
use throughout the demonstration. The details of these plots themselves is not improtant, but we use many different datasets and plotting methodologies in order to illustrate the different avenues for discoverability enabled by trackr's automatic annotations.
